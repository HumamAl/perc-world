...
export const APP_CONFIG = {
  appName: "PERC WORLD",                       // Display name (sidebar header, page title)
  projectName: "PERC WORLD",                   // Client's product name (tab bar microtext, footer)
  clientName: null as string | null,           // Client first name, or null — never render "null"
  domain: "Septic Permit Management",          // Domain classification from Job Analyst
